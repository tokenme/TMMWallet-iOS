...
class TMMWebViewController: UIViewController {
    ...
    lazy var shareParams: NSMutableDictionary = {
        ...
        params.ssdkSetupFacebookParams(byText: shareItem?.description, image: image, url: shareItem?.link, urlTitle: shareItem?.title, urlName: TMMConfigs.Facebook.displayName, attachementUrl: nil, hashtag: "TBC", quote: nil, type: .webPage)
