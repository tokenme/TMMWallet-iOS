...
class ResetPasswordViewController: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        MTA.trackPageViewBegin(TMMConfigs.PageName.resetPasswd)
    }
    
    override func viewWillDisappear(_ animated: Bool) {
        super.viewWillDisappear(animated)
        MTA.trackPageViewEnd(TMMConfigs.PageName.resetPasswd)
    }
...
extension ResetPasswordViewController: CountryPickerViewDelegate {
    func countryPickerView(_ countryPickerView: CountryPickerView, didSelectCountry country: Country) {
        self.countryCode = country.phoneCode
    }
}

extension ResetPasswordViewController: CountryPickerViewDataSource {
...
extension ResetPasswordViewController: RNCountdownButtonDelegate {
