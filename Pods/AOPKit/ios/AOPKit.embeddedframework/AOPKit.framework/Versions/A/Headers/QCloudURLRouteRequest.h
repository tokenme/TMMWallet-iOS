...
/**
 when a pattern is mated. the lib will transform the url to QCloudURLRequest and pust some context in it. you can find some convinice method about url and some context valiable too.
 */
@interface QCloudURLRouteRequest : NSObject
