...
#Quote path in case of spaces or special chars . notice that it half quote!!
DIR=${DIR}
# Bugly服务域名
BUGLY_DSYM_UPLOAD_DOMAIN="api.bugly.qq.com"
JAR_CMD_NAME="buglySymboliOS.jar"
PATH_SEP="/"
JAR_CMD_PATH=$DIR$PATH_SEP$JAR_CMD_NAME


# 注意jar工具的路径跟dSYMUpload.sh脚本路径一致, 请务必保证jar路径的正确性

BUGLY_SYMBOL_JAR_PATH=$JAR_CMD_PATH
# 查找添加到系统目录的jar工具
